...
```json
{
  ...
  "directories": {
    "category_name": {
      "_description": "Brief description of this category.",
      "subcategory_name": {
        "_description": "Description for this subcategory.",
        "files": [
          "concept-icon-1-transparent.png (Transparent version of the first file)",
          "concept-icon-1.png (Standard version of the first file)",
          "concept-icon-2-transparent.png (Transparent version of the second file)",
          "concept-icon-2.png (Standard version of the second file)",
          "concept-icon-3-transparent.png (Transparent version of the third file)",
          "concept-icon-3.png (Standard version of the third file)"
        ]
      },
      "another_subcategory": {
        "_description": "Description for another subcategory.",
        "files": [
          "concept-icon-1-transparent.png (Transparent version)",
          "concept-icon-1.png (Standard version)",
          "concept-icon-2-transparent.png (Transparent version)",
          "concept-icon-2.png (Standard version)"
        ]
      }
    },
    "another_category": {
      "_description": "Brief description of another category.",
      "subcategory_inside_another_category": {
        "_description": "Description of the subcategory.",
        "files": [
          "concept-logo-1-transparent.png (Transparent version)",
          "concept-logo-1.png (Standard version)"
        ]
      }
    }
  }
...
> All image files must be placed directly inside the subcategory folder without extra nesting.

### Notes:

* ✅ Replace `category_name` and `subcategory_name` with actual meaningful names (e.g., `databases` → `mongodb`)

* ✅ File descriptions should be short but clear
  *Example:* `"concept-icon-1.png (Standard icon for XYZ)"`

* ✅ All image/icon files must be named consistently
  *Example:* `concept-icon-1.png`, `concept-logo-1.png`, `concept-logo-1-transparent.png`
...
I will also credit you if you want to showcase your usage!

If you want to share an example of how you use this project, visit: [example usage submission](https://github.com/madhurimarawat/Badger-Icons/blob/main/.github/ISSUE_TEMPLATE/example-usage-submission.md)
If you don’t have time, I will add this for you as well. Just send it over in issues or discussions.

If you do not want to do this here, message me on LinkedIn: [https://www.linkedin.com/in/madhurima-rawat/](https://www.linkedin.com/in/madhurima-rawat/) with your icon or usage. I will add it from there too. Just send your GitHub username and I will credit you.
